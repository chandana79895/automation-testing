   ...
   // private By textToVerifyJapaneseLanguage=By.xpath("//h3[//text()[normalize-space() = '有効ポイント']]");
	...
	//Initializing the Page Objects:
			...
			public void clickOnEnterReceiptButton() {
			 ...
			 public void headerHyperlinkVerificationOnMemberDetailsScreen(WebDriver driver, String expectedUrl) {
			    ...
			    */	
			    ...
			    public void verifySuccessfullNavigationForBackButton(WebDriver driver, String expectedUrl) {
					try {
				        ...
				        if (isUrlChanged) {
				            String currentUrl = driver.getCurrentUrl();
				            System.out.println("Back button successfully navigated to the Member Lookup screen: " + currentUrl);
				            String expectedUrl1 = "https://d1msv2sqknn4w4.cloudfront.net/member-search";
				            Assert.assertEquals(currentUrl, expectedUrl1, "The URL of member lookup screen is incorrect. Back button not working.");
				        } else {
			    ...
			    public void verifySuccessfullNavigationFromMemberDetailsToMemberLookupScreen(WebDriver driver, String expectedUrl) {
					try {
						// Create an instance of WebDriverWait with a timeout of 10 seconds
				        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
				        ...
				        if (isUrlChanged) {
				            ...
				            System.out.println("The URL did not change to the expected URL within the timeout period.i.e, no success navigation from member details to member lookup screen,");
				            Assert.fail("Navigation was not successful as the URL did not change to the expected URL.");
				        }
				    } catch (Exception e) {
				        System.out.println("An error occurred during page verification: " + e.getMessage());
			    ...
			    public void verifySuccessfullNavigationFromMemberDetailsToLocationScreen(WebDriver driver, String expectedUrl) {
					try {
						// Create an instance of WebDriverWait with a timeout of 10 seconds
				        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(30));
				        ...
				        if (isUrlChanged) {
				            ...
				            System.out.println("The URL did not change to the expected URL within the timeout period.i.e, no success navigation from memberDetails to member location screen,");
				            Assert.fail("Navigation was not successful as the URL did not change to the expected URL.");
				        }
				    } catch (Exception e) {
						...
						public void verifyLogoutOptionOnMemberDetailsScreen(WebDriver driver, String expectedUrl) {
				    	...
				    	try {
					        ...
					        if (isUrlChanged) {
					            ...
					            System.out.println("The URL did not change to the expected URL within the timeout period.i.e, no success navigation from member details to Login screen,");
					            Assert.fail("Navigation was not successful as the URL did not change to the expected URL.");
					        }
					    } catch (Exception e) {
