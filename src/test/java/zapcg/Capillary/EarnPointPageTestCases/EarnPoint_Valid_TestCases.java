	...
	public loginPage lp;
	 ...
	 @Test(priority=6)
		public void verifyHeaderHyperlink() {
		 ...
		 epp.headerHyperlinkVerificationOnEarnPointsScreen(driver, "https://d1msv2sqknn4w4.cloudfront.net/location-search");	
	}
	 ...
	 @Test(priority=7)
		public void verifyBackButtonNavigation() {
		 ...
		 epp.verifySuccessfullNavigationForBackButton(driver, "https://d1msv2sqknn4w4.cloudfront.net/member-details");	
	}
	 ...
	 @Test(priority=8)
		public void verifyHamBurgerMemberLookupOption() throws InterruptedException {
		 ...
		 Thread.sleep(1000);
		 epp.verifySuccessfullNavigationFromEarnPointsToMemberLookupScreen(driver, "https://d1msv2sqknn4w4.cloudfront.net/member-search");
	 ...
	 @Test(priority=9)
		public void verifyHamBurgerLocationOption() throws InterruptedException {
		 ...
		 Thread.sleep(1000);
		 epp.verifySuccessfullNavigationFromEarnPointToLocationScreen(driver, "https://d1msv2sqknn4w4.cloudfront.net/location-search");
	 ...
	 @Test(priority=10)
		public void verifyHamBurgerLogoutOption() throws InterruptedException {
		 ...
		 epp.chooseLogout();
		 Thread.sleep(1000);
		 epp.verifyLogoutOptionOnEarnPointsScreen(driver, "https://d1msv2sqknn4w4.cloudfront.net/login");
